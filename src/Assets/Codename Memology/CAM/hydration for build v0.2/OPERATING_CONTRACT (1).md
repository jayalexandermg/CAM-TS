# Operating Contract: Memory_System_Builder

**Version:** 1.0  
**Project:** Infinite Aura Memory System v1  
**Role:** Builder agent responsible for implementing the filesystem-based memory system
...
All files go in `~/.infinite-aura/memory/` per Brief:
```
memory/
├── user_context.md
├── current_projects.md
...
*Contract authored for Infinite Aura. Use with any LLM capable of following structured instructions.*
